...
* `Mac` No got several errors. After
...
* `Mac` In the beginning, we could not run any tests on the Mac computer. After a while, we managed to run the tests in the terminal and in IDEA.
